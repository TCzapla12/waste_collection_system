namespace PDI.SimulationModule.Model
{
    ...
    public class ServiceClient
    {
        ...
        public R CallWebService<R, C>(HttpMethod httpMethod, string webServiceUri, C content )
        {
        ...
        public async Task<R> CallWebServiceAsync<R,C>(HttpMethod httpMethod, string webServiceUri, C content)
        {
        ...
        public async Task<string> CallWebService<C>(HttpMethod httpMethod, string callUri, C content)
        {
            string httpUri = String.Format("http://{0}:{1}/{2}", this.serviceHost, this.servicePort, callUri);
