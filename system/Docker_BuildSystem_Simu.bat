...
docker build -f ../applicationservicedispatcher/PDI.AppServiceDispatcher.Rest/Dockerfile_Simu.dev -t tczaplic/pdi:appservicedispatcherrest ../applicationservicedispatcher
...
docker build -f ../simulationmodule/PDI.SimulationModule.Rest/Dockerfile.prod -t tczaplic/pdi:simulator ../simulationmodule
